...
namespace TaCertoForms.Factory{
    public class TurmaDisciplinaAutorMatrizCreator : BaseCreator, IFactoryTurma{

        public TurmaDisciplinaAutorMatrizCreator(int IdMatriz, int IdPessoa) : base(IdMatriz, IdPessoa) { }
